...
public class SwipeStack extends ViewGroup {
    ...
    public void onSwipeProgress(float progress,int swipeposition) {
        if (mProgressListener != null)
            mProgressListener.onSwipeProgress(getCurrentPosition(), progress,swipeposition);
    }
    ...
    public void onViewSwipedToUndoR(int i) {
        if (mListener != null) mListener.onViewSwipedToRight(i);
        removeTopView();
    }

    public void onViewSwipedToUndoL(int i) {
        if (mListener != null) mListener.onViewSwipedToLeft(i);
        removeTopView();
    }

    public void onViewSwipeToTop(){
        if(mListener != null) mListener.onViewSwipedToTop(getCurrentPosition());
        removeTopView();
    }
    ...
    public interface SwipeProgressListener {
         ...
         */
        void onSwipeProgress(int position, float progress,int swipeposition);
