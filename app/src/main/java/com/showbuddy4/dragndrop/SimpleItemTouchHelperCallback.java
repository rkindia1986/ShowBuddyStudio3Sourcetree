package com.showbuddy4.dragndrop;
...
public class SimpleItemTouchHelperCallback extends ItemTouchHelper.SimpleCallback {
    ...
    public int getSwipeDirs(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if (((TopGeneralLIstAdapter)mAdapter).isPendingRemoval(position)) {
            return 0;
        }
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
        ...
        ((TopGeneralLIstAdapter)mAdapter).pendingRemoval(swipedPosition,swipeDir);
    }
